...
export class DriverAssignmentStatusUpdate1758462927279 implements MigrationInterface {
    name = 'DriverAssignmentStatusUpdate1758462927279'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."order_driver_assignment_status_enum" AS ENUM('accepted', 'assigned', 'rejected', 'picked', 'delivered')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."order_driver_assignment_status_enum_old" AS ENUM('accepted', 'assigned', 'rejected', 'picked')`);
        await queryRunner.query(`ALTER TABLE "order_driver_assignment" ALTER COLUMN "status" DROP DEFAULT`);
